...
public class EditorManager {
	...
	public static void setup() {
		ENGINE.getConfigManager().extract("src/main/resources/editor");
		
		if (EDITOR_ACTIONS_MAIN == null || !EDITOR_ACTIONS_MAIN.reload()) {
			EDITOR_ACTIONS_MAIN = JYML.loadOrExtract(ENGINE, "/src/main/resources/editor/actions_main.yml");
		}
		if (EDITOR_ACTIONS_SECTION == null || !EDITOR_ACTIONS_SECTION.reload()) {
			EDITOR_ACTIONS_SECTION = JYML.loadOrExtract(ENGINE, "/src/main/resources/editor/actions_section.yml");
		}
		if (EDITOR_ACTIONS_PARAMETIZED == null || !EDITOR_ACTIONS_PARAMETIZED.reload()) {
			EDITOR_ACTIONS_PARAMETIZED = JYML.loadOrExtract(ENGINE, "/src/main/resources/editor/actions_parametized.yml");
		}
		if (EDITOR_ACTIONS_PARAMS == null || !EDITOR_ACTIONS_PARAMS.reload()) {
			EDITOR_ACTIONS_PARAMS = JYML.loadOrExtract(ENGINE, "/src/main/resources/editor/actions_params.yml");
		}
