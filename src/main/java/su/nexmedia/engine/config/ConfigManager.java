...
public class ConfigManager<P extends NexPlugin<P>> {
	...
	public void setup() {
		this.extract("src/main/resources/lang");
		
		this.configMain = JYML.loadOrExtract(plugin, "src/main/resources/config.yml");
		this.configLang = JYML.loadOrExtract(plugin, "/src/main/resources/lang/messages_" + configMain.getString("core.lang", "en").toLowerCase() + ".yml");
